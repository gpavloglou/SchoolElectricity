...
2)	Indicate whether on SWEP Electricity. If on SWEP, then must be indicated as having had sensors installed for at least 12 months (**already confirmed in creation of dataset**).
...
4)	Indicate if they were Resource Smart Schools. But they must have been on this program for all 12 months (**already confirmed in creation of dataset**).
...
This is not surprising since there are no Urban/metropolitan schools in Climate Zone 4
(Climate Zone 4 mostly covers NW Victoria). The coefficient for BCAZone_4, which is practically zero, is also evidence of this. This has resulted in 'singularity' or perfect multicollinearity, which has lead to unstable results.
...
f3.1.1_pred_3%>%
  ...
  theme(text=element_text(size=14),
        plot.subtitle = element_text(hjust=0.5),
        plot.caption = element_text(hjust=0.0, size=10)
